...
и извлечённых файлов, тип файлов, owner и права проверяются до каждого запуска.
...
- оператор знает фактический исходящий IPv4 shared-hosting. IP сайта и egress-IP
  могут различаться;
...
5. В списке сайтов скопируйте фактический `document root`; не составляйте путь
   вручную.
6. Получите у провайдера SSH/SFTP host-key fingerprint.
