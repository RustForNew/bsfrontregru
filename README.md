...
3. В ISPmanager создайте сайт без PHP и назначьте этот FQDN. Обязательно включите
   SSL для vhost сайта на 443. Для обычного режима выпустите Let's Encrypt; для
   pin-сценария можно выбрать выданный хостингом или самоподписанный сертификат.
   Снимать SHA-256 можно только после сохранения SSL-настроек сайта.
